...
<?php
        ...
        echo "<h3>¿Está seguro de querer contratar a $usuario->Nombre?</h3>";
    ?>
...
<?php
       echo "<a href='../Transactions/ContratarBD.php?id=$usuario->Id' class='btn btn-warning'>Contratar <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil-square' viewBox='0 0 16 16'>
